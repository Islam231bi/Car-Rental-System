...
<script>
   document.getElementById("form1").onsubmit = () => {
      ...
      license = document.getElementById("lic").value;
      password = document.getElementById("pass").value;
      validateSsn = ssnRegex.test(license);
      passValidate = passRegex.test(password);
      // if(!validateSsn){
      //    document.getElementById("lisenceerror").style.display = "block";
      //    setTimeout(function(){
      //       document.getElementById("lisenceerror").style.display = "none";
      //    },2000)
      //    return false;
      // }
